...
const mutating = true
// let startRand = Math.random() * 0.001
let randSeed = Math.floor(Math.random() * 1000)
let randSeed2 = Math.floor(Math.random() * 1000)
...
function setup() {
    ...
    // seasonButton.addEventListener('click', restartTrees);
    mutate()
...
function draw() {
  ...
  push();
  translate(width * 0.75, height + 15)
  scale(1, -1)
  translate(0, 20)
  branch(1, randSeed)
  pop()
  ...
  push()
  translate(width * 0.65, height + 15)
  scale(1, -1)
  translate(0, 20)
  branch(1, randSeed2)
  pop()
